          ...
          <div className="mb-16 text-center">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4">
              <a
                ...
                className="flex items-center gap-2 rounded-xl border border-border bg-card px-6 py-3 text-sm font-medium text-foreground transition-all hover:border-primary/40 card-hover"
              >
